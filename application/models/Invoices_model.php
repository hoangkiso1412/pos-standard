...
class Invoices_model extends CI_Model
{
    ...
    {
        $this->db->select('geopos_invoice_items.*,tb_stock.body_number,tb_stock.engine_number,tb_stock.plate_number,tb_stock.selling_price,tb_stock.paid_amount,tb_stock.remain_amount,tb_stock.purchase_paid_amount');
        $this->db->from('geopos_invoice_items');

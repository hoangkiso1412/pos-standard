...
class Sale_summary extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('sale_summary_model', 'purchase');
    ...
    public function create()
    {
        ...
        $this->load->view('all_reports/newinvoice', $data);
    ...
    public function edit()
    {
        ...
        $this->load->view('fixed/header', $head);
        $this->load->view('all_reports/edit', $data);
        $this->load->view('fixed/footer');
    ...
    public function index()
    {
        ...
        $head['usernm'] = $this->aauth->get_user()->username;
        $this->load->view('fixed/header', $head);
        $this->load->view('all_reports/invoices');
        $this->load->view('fixed/footer');
    }
    ...
    public function view()
    {
        ...
        $head['usernm'] = $this->aauth->get_user()->username;
        $this->load->view('fixed/header', $head);
        if ($data['invoice']['tid']) $this->load->view('all_reports/view', $data);
        $this->load->view('fixed/footer');

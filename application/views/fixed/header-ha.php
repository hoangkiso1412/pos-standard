                ...
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right"><?php if ($this->aauth->get_user()->roleid == 5) { ?>
                        <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link " href="#"
                                data-toggle="dropdown"> <?php echo $this->lang->line('Configure') ?>
                                        ...
                                        <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                            <div class="card-header p-0 pb-1 border-0 mt-1" id="heading1" role="tab">
                                                <a class=" text-uppercase black" data-toggle="collapse"
                                                    ...
                                                    <?php echo $this->lang->line('Business') . '  ' . $this->lang->line('Settings') ?>
                                                </a></div>
                                                ...
                                                <div class="card-content">
                                                    <ul>
                                                        <li><a class="dropdown-item"
                                                                ...
                                                                <?php echo $this->lang->line('Company') . ' ' . $this->lang->line('Settings') ?>
                                                            </a></li>
                                                        ...
                                                        <li class="hidden"><select class="dropdown-item"
                        ...
                        ?></select></li>
                                            ...
                                            <div class="hidden card-header p-0 pb-1 border-0 mt-1" id="heading2" role="tab">
                                                <a class=" text-uppercase black" data-toggle="collapse"
                                            ...
                                            <div class=" hidden card-collapse collapse mb-1 " id="accordion2" role="tabpanel"
                                ...
                                <li class="col-md-3">
                                    ...
                                    <div id="accordionWrap1" role="tablist" aria-multiselectable="true">
                                        <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                            <div class="hidden card-header p-0 pb-1 border-0 mt-1" id="heading4" role="tab">
                                                <a class=" text-uppercase black" data-toggle="collapse"
                                                ...
                                                <div class="card-content">
                                                    <ul>
                                                        ...
                                                        <li><a class="dropdown-item"
                                                                ...
                                                                <?php echo $this->lang->line('Fields') ?>
                                                            </a></li>
                                                        <li><a class="dropdown-item"
                                                                href="<?php echo base_url(); ?>settings/dual_entry"><i
                                                                    class="ft-chevron-right"></i>
                                                                <?php echo $this->lang->line('Dual Entry') . ' ' . $this->lang->line('Accounting') ?>
                                                            </a></li>
                                                        <li><a class="dropdown-item"
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a class="dropdown-item"
                                                                href="<?php echo base_url(); ?>settings/taxslabs"><i
                                                                    class="ft-chevron-right"></i>
                                                                <?php echo $this->lang->line('Other') . ' ' . $this->lang->line('Tax') . ' ' . $this->lang->line('Settings') ?>
                                                            </a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <li class="col-md-3">
                                    ...
                                    <div id="accordionWrap2" role="tablist" aria-multiselectable="true">
                                        <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a class="dropdown-item"
                                                                href="<?php echo base_url(); ?>units/variables"><i
                                                                    class="ft-chevron-right"></i>
                                                                <?php echo $this->lang->line('Variations') . ' ' . $this->lang->line('Variables') ?>
                                                            </a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="hidden card-header p-0 pb-1 border-0 mt-1" id="heading9" role="tab">
                                                <a class=" text-uppercase black" data-toggle="collapse"
                                            ...
                                            <div class="hidden card-collapse collapse mb-1 " id="accordion9" role="tabpanel"
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a class="dropdown-item hidden"
                                                                href="<?php echo base_url(); ?>settings/registration"><i
                                                                    class="ft-chevron-right"></i>
                                                                <?php echo $this->lang->line('CRM') . ' ' . $this->lang->line('Settings') ?>
                                                            </a></li>
                                                        <li><a class="dropdown-item hidden"
                        ...
                        <li class="hidden dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#"
                      ...
                      <div class="media">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                    ...
                                    <?php echo 'ពត៌មានផ្ទាល់ខ្លួន';//$this->lang->line('Profile') ?></a>
                                <a href="<?php echo base_url(); ?>user/attendance" class="dropdown-item hidden"><i
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>reports/commission"
                            data-toggle="dropdown"><?= $this->lang->line('Employee'); ?>

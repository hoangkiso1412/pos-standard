                            ...
                            <div class="title-action">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="#sendEmail" data-toggle="modal" data-remote="false" class="dropdown-item sendbill" data-type="notification">
                                            <?php echo $this->lang->line('Invoice Notification') ?>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a href="#sendEmail" data-toggle="modal" data-remote="false" class="dropdown-item sendbill" data-type="reminder">
                                            <?php echo $this->lang->line('Payment Reminder') ?>
                                        </a>
                                        <a href="#sendEmail" data-toggle="modal" data-remote="false" class="dropdown-item sendbill" data-type="received">
                                            <?php echo $this->lang->line('Payment Received') ?>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a href="#sendEmail" data-toggle="modal" data-remote="false" class="dropdown-item sendbill" href="#" data-type="overdue">
                                            <?php echo $this->lang->line('Payment Overdue') ?>
                                        </a>
                                        <a href="#sendEmail" data-toggle="modal" data-remote="false" class="dropdown-item sendbill" data-type="refund">
                                            <?php echo $this->lang->line('Refund Generated') ?>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-left">
                        <ul class="px-0 list-unstyled">
                            ...
                            <li class="text-bold-800">
                                <a href="#">
                                    <strong class="invoice_a"><?php echo $customer_info[0] ?></strong>
                                </a>
                            </li>
                            <li><?php echo "Gender: " . $customer_info[1] . ", Age: " . $customer_info[2] ?></li>
                            <li><?php echo "ID Card: " . $customer_info[3] . ", Phone Number: " . $customer_info[4] ?></li>
                            <li><?php echo "#" . $customer_info[5] . ", St " . $customer_info[6] . ", " . $customer_info[7] . ", " . $customer_info[8] ?></li>
                            <li><?php echo $customer_info[9] . ", " . $customer_info[10] . ", " . $customer_info[11] ?></li>
                        </ul>
                    </div>
                                ...
                                <?php if ($invoice['taxstatus'] == 'cgst') { ?>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-xs-left"><?php echo $this->lang->line('Frame Number') ?></th>
                                            <th class="text-xs-left"><?php echo $this->lang->line('Engine Number') ?></th>
                                            <th class="text-xs-left"><?php echo $this->lang->line('Plate Number') ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['plate_number']?$row['plate_number']:$this->lang->line('New') ?></td>
                                                <td><?php echo amountExchange($row['price'], 0, $this->aauth->get_user()->loc) ?></td>
                                                <td><?php echo amountExchange($row['totaldiscount'], 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($row['discount']) . $this->lang->line($invoice['format_discount']) . '%)' ?></td>
                                                <td><?php echo amountExchange($gst, 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($rate) . '%)' ?></td>
                                                <td><?php echo amountExchange($gst, 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($rate) . '%)' ?></td>                           
                                                <td><?php echo amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan=11><?php $row['product_des'] ?></td>
                                            </tr>
                                            <?php
                                            $c++;
                                        }
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo amountExchange($row['price'], 0, $this->aauth->get_user()->loc) ?></td>
                                                <td><?php echo amountExchange($row['totaldiscount'], 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($row['discount']) . $this->lang->line($invoice['format_discount']) . ')' ?></td>
                                                <td><?php echo amountExchange($row['totaltax'], 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($row['tax']) . '%)' ?></td>
                                                <td><?php echo amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan=10><?php echo $row['product_des'] ?></td>
                                            </tr>
                                            <?php
                                            $c++;
                                        }
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            <tr>
                                                <td colspan=9><?php echo $row['product_des'] ?></td>
                                            </tr>
                                            <?php
                                            $c++;
                                        }

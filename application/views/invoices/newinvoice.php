                ...
                <form method="post" id="data_form">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Customer's Name" name="customername" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <label for="customergender" class="caption"><?php echo $this->lang->line("Gender") ?></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Gender" name="customergender" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <label for="customerage" class="caption"><?php echo $this->lang->line("Age") ?></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Age" name="customerage" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="ID Card" name="customeridcard" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="customerphone" class="caption"><?php echo $this->lang->line("Phone Number") ?></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Phone Number" name="customerphone" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="House Number" name="customerhouse" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <label for="customerstreet" class="caption"><?php echo $this->lang->line("Street") ?></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Street" name="customerstreet" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <label for="customergroup" class="caption"><?php echo $this->lang->line("Group") ?></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Group" name="customergroup" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Commune" name="customercommune" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <label for="customerdistrict" class="caption"><?php echo $this->lang->line("District") ?></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Phone Number" name="customerdistrict" value="">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <label for="customercity" class="caption"><?php echo $this->lang->line("Province")."/".$this->lang->line("City") ?></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Province/City" name="customercity" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <span class="icon-calendar4" ria-hidden="true"></span>
                                            </div>
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                                ...
                                <tr>
                                    <td>
                                        <input type="text" class="form-control" name="product_name[]"
                                               data-text='detail-item' placeholder="<?php echo $this->lang->line('Enter Product name') ?>"
                                               id='productname-0'>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="product_machine_num[]"
                                               data-text='detail-item' placeholder="" id='productmachinenumber-0'>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="product_plate_num[]"
                                               data-text='detail-item' placeholder="" id='productplatenumber-0'>
                                    </td>
                                    <td>
                            ...
                            <input type="hidden" class="psIn" name="psid[]" id="psid-0" value="0">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td class="reverse_align" colspan="6">
                                    <input type="submit"
                                        ...
                                        id="sale-submit-data" data-loading-text="Creating...">
                                </td>
                            </tr>
                        </tbody>
                        </table>
